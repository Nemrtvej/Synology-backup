...
mount -t cifs -o "ro,iocharset=${REMOTE_SERVER_FILESYSTEM_CHARSET},username=${REMOTE_SERVER_USER_NAME},password=${REMOTE_SERVER_USER_PASSWORD},vers=3.0" "//${REMOTE_SERVER_IP}/${REMOTE_SERVER_DIRECTORY}" "${LOCAL_MOUNTPOINT}"
